...
const Navbar: React.FC = () => {
  ...
  const activeSection = useActiveSection(['home', 'about', 'experience', 'skills', 'projects', 'contact']);
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            >
              ...
              <div className="hidden sm:block">
                <p className="text-white font-bold font-display text-sm leading-none">Abhinav Singh</p>
                <p className="text-cyan-400 text-xs font-mono">Full Stack Engineer</p>
              </div>
            </motion.a>
