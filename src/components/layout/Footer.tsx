...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative border-t border-white/5 py-12 overflow-hidden" aria-label="Footer">
      {/* Background glow */}
      <div
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-bold font-display text-white">Abhinav Singh</span>
            </div>
            <p className="text-xs text-white/35 max-w-xs text-center md:text-left">
              Full Stack Software Engineer — Building the web, one commit at a time.
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: FaGithub, href: 'https://github.com/Abhinav6072', label: 'GitHub' },
              { icon: FaLinkedin, href: 'https://www.linkedin.com/in/abhinav-singh-a6a5b3385', label: 'LinkedIn' },
              { icon: Mail, href: 'mailto:abhinava2k@gmail.com', label: 'Email' },
        ...
        <div className="mt-8 pt-6 border-t border-white/5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <p className="text-xs text-white/20 flex items-center gap-1.5">
              Built with <Heart size={10} className="text-red-400" /> using React, TypeScript & Framer Motion
            </p>
          </div>
        </div>
      </div>
