      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-5rem)]">
          ...
          <div className="flex flex-col justify-center py-12 lg:py-0 order-2 lg:order-1">
            ...
            >
              Building{" "}
              <span className="text-cyan-400 font-medium">scalable</span>,{" "}
            ...
            >
              ...
              {[
                {
                  text: "React",
                  color: "#61DAFB",
                  pos: "top-4 -left-8 sm:-left-16",
                  delay: 0,
                },
                {
                  text: "Node.js",
                  color: "#339933",
                  pos: "top-1/3 -right-6 sm:-right-14",
                  delay: 0.5,
                },
                {
                  text: "MongoDB",
                  color: "#47A248",
                  pos: "bottom-1/4 -left-8 sm:-left-16",
                  delay: 1,
                },
                {
                  text: "TypeScript",
                  color: "#3178C6",
                  pos: "bottom-4 -right-6 sm:-right-14",
                  delay: 1.5,
                },
              ...
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(6,182,212,0.2) 0%, rgba(168,85,247,0.15) 50%, transparent 70%)",
                    filter: "blur(20px)",
                    transform: "scale(1.1)",
                  }}
                  aria-hidden="true"
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 0 40px rgba(6,182,212,0.25), 0 0 80px rgba(168,85,247,0.15), inset 0 0 40px rgba(6,182,212,0.05)",
                  }}
                >
                  <img
                    src="/profile.jpg"
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, transparent 60%, rgba(2,4,8,0.3) 100%)",
                    }}
                    aria-hidden="true"
                  />
                </div>
