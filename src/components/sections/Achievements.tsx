...
const Achievements: React.FC = () => {
  ...
  return (
    <section id="achievements" className="relative py-24 overflow-hidden" aria-label="Achievements section">
      <div className="section-container" ref={ref}>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-orange-400 text-sm font-mono tracking-wider uppercase">Milestones</span>
            ...
            >
              ...
              >
                {ach.icon.startsWith('Si') ? (
                  <span style={{ color: ach.color }} className="text-2xl">★</span>
                ) : (
                  <span>{ach.icon}</span>
                )}
              </div>
              ...
              <h3 className="font-bold font-display text-white text-sm mb-1">{ach.title}</h3>
              <p className="text-xs text-white/40 mb-3 font-mono">{ach.platform}</p>
