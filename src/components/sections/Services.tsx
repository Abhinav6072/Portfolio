...
const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="relative py-24 overflow-hidden" aria-label="Services section">
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full opacity-[0.04]"
          style={{ background: 'radial-gradient(ellipse, #3B82F6, transparent)', filter: 'blur(80px)' }}
        />
      </div>
      ...
      <div className="section-container" ref={ref}>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-blue-400 text-sm font-mono tracking-wider uppercase">What I Offer</span>
          ...
          <p className="section-subtitle mx-auto mt-3 text-center">
            End-to-end development solutions tailored to build, scale, and optimize your digital products.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {services.map((service, i) => (
            ...
            >
              ...
              <h3 className="font-bold font-display text-white text-sm mb-2">{service.title}</h3>
        ...
        >
          <p className="text-white/40 text-sm mb-4">Need a custom solution? Let's talk about your project.</p>
          <button
