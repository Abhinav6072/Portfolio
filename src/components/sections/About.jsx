...
const cards = [
  {
    ...
    color: "#06B6D4",
    content:
      "I build end-to-end web applications using the MERN stack — from designing intuitive UIs to architecting scalable backend systems.",
  },
  {
    icon: Target,
    title: "My Goal",
    color: "#A855F7",
    content:
      "Join a top-tier product company where I can solve real problems at scale. I'm actively seeking full-time roles, remote opportunities, and freelance projects.",
  },
  {
    icon: Zap,
    title: "My Passion",
    color: "#3B82F6",
    content:
      "I love the intersection of beautiful design and powerful engineering. Turning complex problems into elegant, performant solutions is what drives me.",
  },
  {
    icon: Heart,
    title: "My Values",
    color: "#10B981",
    content:
      "Clean code, continuous learning, and shipping quality products. I believe attention to detail separates good developers from great ones.",
  },
];
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              >
                <p className="text-white/80 text-lg leading-relaxed mb-4">
                  ...
                  specializing in JavaScript, React, Node.js, Express.js, and
                  MongoDB.
                </p>
                <p className="text-white/60 leading-relaxed mb-4">
                  I enjoy solving real-world problems, designing scalable
                  backend systems, creating modern user experiences, and
                  building production-ready applications that make a difference.
                </p>
                <p className="text-white/60 leading-relaxed">
                  ...
                  where I can bring significant value and grow rapidly.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {cards.map(({ icon: Icon, title, color, content }, i) => (
                ...
                >
                  ...
                  <h3 className="font-bold font-display text-white text-base mb-2">
                    {title}
                  </h3>
