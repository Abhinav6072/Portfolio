...
const ProjectCard = ({ project, index, isInView, onOpen }) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Features */}
          <div>
            <h3 className="font-bold font-display text-white mb-3">
              Key Features
            </h3>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              <h3 className="font-bold font-display text-white mb-2 text-sm">
                Architecture
              </h3>
          ...
          >
            <h3 className="font-bold font-display text-purple-400 mb-2 text-sm">
              🚀 Future Improvements
            </h3>
      ...
      <div className="section-container" ref={ref}>
        ...
        >
          ...
          <p className="section-subtitle mt-3">
            Production-ready applications built with scalability, performance,
            and beautiful UX in mind.
          </p>
        </motion.div>
        ...
        >
          <p className="text-white/40 text-sm mb-4">
            Want to see more? Check out all my repositories.
          </p>
          <a
