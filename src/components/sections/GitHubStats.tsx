...
const pinnedRepos = [
  { name: 'Smart-ELearning-Platform', desc: 'Full-stack e-learning platform with MERN stack', stars: 12, forks: 4, lang: 'JavaScript', langColor: '#F7DF1E' },
  { name: 'Doctor-Appointment-System', desc: 'Healthcare appointment booking app with 3 panels', stars: 8, forks: 3, lang: 'JavaScript', langColor: '#F7DF1E' },
  { name: 'LeetCode-Clone', desc: 'Competitive coding platform with Monaco editor', stars: 15, forks: 6, lang: 'TypeScript', langColor: '#3178C6' },
];
...
const GitHubStats: React.FC = () => {
  ...
  return (
    <section id="github" className="relative py-24 overflow-hidden" aria-label="GitHub section">
      ...
      <div className="section-container" ref={ref}>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-cyan-400 text-sm font-mono tracking-wider uppercase">Open Source</span>
        ...
        >
          <h3 className="font-bold font-display text-white mb-5 text-center">Pinned Repositories</h3>
            ...
            {pinnedRepos.map((repo, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <ExternalLink size={12} className="text-white/20 group-hover:text-cyan-400 transition-colors" />
                </div>

                <h4 className="font-semibold text-white text-xs mb-2 group-hover:text-cyan-400 transition-colors line-clamp-1">
                  {repo.name.replace(/-/g, ' ')}
                </h4>
                <p className="text-white/40 text-xs mb-3 leading-relaxed line-clamp-2">{repo.desc}</p>
