...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="relative py-24 overflow-hidden" aria-label="Experience section">
      {/* Background */}
      ...
      <div className="section-container" ref={ref}>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-cyan-400 text-sm font-mono tracking-wider uppercase">Journey</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            >
              ...
              <h3 className="font-bold font-display text-white text-lg">Work Experience</h3>
            </motion.div>
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{ background: 'linear-gradient(180deg, rgba(6,182,212,0.4), rgba(168,85,247,0.2), transparent)' }}
                aria-hidden="true"
              />
              ...
              {experiences.map((exp, i) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex-shrink-0">
                    <motion.div
                      animate={{ boxShadow: [`0 0 0 0 ${exp.color}40`, `0 0 0 8px transparent`] }}
                  ...
                  >
                    <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                      <div>
                        <h4 className="font-bold font-display text-white">{exp.role}</h4>
                    ...
                    <p className="text-white/60 text-sm mb-4 leading-relaxed">{exp.description}</p>

                    <ul className="space-y-2 mb-4" role="list">
                      {exp.responsibilities.map((resp, ri) => (
                        <li key={ri} className="flex gap-2 text-sm text-white/55">
          ...
          <div>
            ...
            >
              ...
              <h3 className="font-bold font-display text-white text-lg">Education</h3>
            </motion.div>
            ...
            {education.map((edu, i) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h4 className="font-bold font-display text-white">{edu.degree}</h4>
                    <p style={{ color: edu.color }} className="text-sm font-medium">{edu.institution}</p>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-semibold text-white text-sm">Currently Learning</h4>
              </div>
              <div className="flex flex-wrap gap-2">
                {['System Design', 'AWS Cloud', 'Redis', 'Kubernetes', 'GraphQL', 'AI/ML Integration'].map((item) => (
                  <span
                    key={item}
