          ...
          >
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                ...
                <strong className="text-emerald-400">Full-Time roles</strong>,{" "}
                <strong className="text-blue-400">Remote opportunities</strong>,
                and{" "}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label
                    ...
                    className="block text-xs font-mono text-white/40 mb-2"
                  >
                    Your Name *
                  </label>
                  <input
